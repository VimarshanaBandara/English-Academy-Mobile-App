        ...
        child: Scaffold(
          ...
          appBar: AppBar(
            ...
            title: Row(
              ...
              children: [
                Text('May have',style: TextStyle(color: Colors.white,fontWeight: FontWeight.bold),),
                SizedBox(width: 8.0,),
                Text('/',style: TextStyle(color: Colors.white,fontWeight: FontWeight.bold),),
                SizedBox(width: 8.0,),
                Text('Might have',style: TextStyle(color: Colors.white,fontWeight: FontWeight.bold),)
              ],
            ),
