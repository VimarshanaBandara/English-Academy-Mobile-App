          ...
          child:Container(
            ...
            child:  Padding(
              ...
              child: Column(
                children: [
                  Center(
                    child: Text('Your friend has missed the bus.',style: TextStyle(fontSize: 22.0,fontWeight:FontWeight.bold,color: Colors.pink,),),
                  ),
                  ...
                  Center(
                    child: Text('Your friend has a difficult exam.',style: TextStyle(fontSize: 22.0,fontWeight:FontWeight.bold,color: Colors.pink,),),
                  ),
                  SizedBox(height: 20.0,),
                  ...
                  Center(
                    child: Text('Your friend is lazy.',style: TextStyle(fontSize: 22.0,fontWeight:FontWeight.bold,color: Colors.pink,),),
                  ),
                  SizedBox(height: 20.0,),
                  ...
                  Center(
                    child: Text('Your friend need some money.',style: TextStyle(fontSize: 22.0,fontWeight:FontWeight.bold,color: Colors.pink,),),
                  ),
                  SizedBox(height: 20.0,),
                  ...
                  Center(
                    child: Text('Your friends car wont start.',style: TextStyle(fontSize: 22.0,fontWeight:FontWeight.bold,color: Colors.pink,),),
                  ),
                  SizedBox(height: 20.0,),
